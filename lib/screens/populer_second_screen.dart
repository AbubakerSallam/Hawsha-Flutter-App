...
class PopulerSecondScreen extends StatefulWidget {
  const PopulerSecondScreen({super.key});

  @override
  PopulerSecondScreenState createState() => PopulerSecondScreenState();
}

class PopulerSecondScreenState extends State<PopulerSecondScreen> {
  double opacity = 1;
                ...
                child: Column(
                  children: [
                    ...
                    const AnimatedWidgets(
                      delay: 300,
                      child: FullEventCard(
                        imageLocation: 'lib/assets/m2.jpg',
                        eventName: 'رونق',
                        eventDetails: 'خدمات VIP •',
                        category: 'حجز',
                      ),
                    ),
                    const SizedBox(height: 10),
                    const AnimatedWidgets(
                      delay: 300,
                      child: FullEventCard(
                        imageLocation: 'lib/assets/m4.jpg',
                        eventName: 'نون',
                        eventDetails: '• ثاني أكبر تقييم',
                        category: 'حجز',
                      ),
                    ),
                  ],
